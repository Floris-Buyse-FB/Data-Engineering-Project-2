...
CREATE TABLE DimSessie (
    ...
    campaignID VARCHAR(255),
    inschrijvingsID VARCHAR(255), -- van tabel SessieInschrijving (merge joinen)
    startDatumTijd DATE,    
    eindDatumTijd DATE,
    product VARCHAR(255),
...
-- pageviews vallen voorlopig weg
...
CREATE TABLE DimAfspraak (
    ...
    accountID VARCHAR(255),
    FOREIGN KEY (contactID) REFERENCES DimContact(contactID),
    FOREIGN KEY (accountID) REFERENCES DimAccount(accountID),
